...
static const BuiltinDef BUILTINS[] = {
    ...
    {"string->i128", 2101, 1}, {"i128?", 2102, 1},
    {"i128-add", 2103, 2}, {"i128-sub", 2104, 2}, {"i128-mul", 2105, 2},
    {"i128-quotient", 2106, 2}, {"i128-remainder", 2107, 2},
    {"i128-neg", 2108, 1},
    {"i128-shl", 2109, 2}, {"i128-ashr", 2110, 2}, {"i128-lshr", 2111, 2},
    ...
    /* ESH-0011 portable event loop — IDs 2220-2225. The VM calls the same
