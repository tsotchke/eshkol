...
ONE_ARG_BUILTIN(formatRelative, "eshkol_builtin_format_relative")
ZERO_ARG_BUILTIN(localTimezoneOffset, "eshkol_builtin_local_timezone_offset")
...
ZERO_ARG_BUILTIN(arenaUsed, "eshkol_builtin_arena_used")
/* AD Phase A instrumentation counters */
ZERO_ARG_BUILTIN(adResetCounters, "eshkol_builtin_ad_reset_counters")
...
ZERO_ARG_BUILTIN(compressionAvailable, "eshkol_builtin_compression_available")
ONE_ARG_BUILTIN(deflateBuiltin, "eshkol_builtin_deflate")
ONE_ARG_BUILTIN(inflateBuiltin, "eshkol_builtin_inflate")
ONE_ARG_BUILTIN(gzipBuiltin, "eshkol_builtin_gzip")
ONE_ARG_BUILTIN(gunzipBuiltin, "eshkol_builtin_gunzip")
ZERO_ARG_BUILTIN(yogaNodeCreate, "eshkol_builtin_yoga_node_create")
THREE_ARG_BUILTIN(yogaNodeSet, "eshkol_builtin_yoga_node_set")
TWO_ARG_BUILTIN(yogaNodeAddChild, "eshkol_builtin_yoga_node_add_child")
THREE_ARG_BUILTIN(yogaNodeCalculate, "eshkol_builtin_yoga_node_calculate")
TWO_ARG_BUILTIN(yogaNodeGetComputed, "eshkol_builtin_yoga_node_get_computed")
ONE_ARG_BUILTIN(yogaNodeFree, "eshkol_builtin_yoga_node_free")
ONE_ARG_BUILTIN(tsParserNew, "eshkol_builtin_ts_parser_new")
ONE_ARG_BUILTIN(tsParserFree, "eshkol_builtin_ts_parser_free")
TWO_ARG_BUILTIN(tsParse, "eshkol_builtin_ts_parse")
ONE_ARG_BUILTIN(tsTreeFree, "eshkol_builtin_ts_tree_free")
ONE_ARG_BUILTIN(tsNodeType, "eshkol_builtin_ts_node_type")
TWO_ARG_BUILTIN(tsNodeText, "eshkol_builtin_ts_node_text")
ONE_ARG_BUILTIN(tsNodeChildren, "eshkol_builtin_ts_node_children")
TWO_ARG_BUILTIN(tsQueryNew, "eshkol_builtin_ts_query_new")
THREE_ARG_BUILTIN(tsQueryMatches, "eshkol_builtin_ts_query_matches")
...
/* (ad-tape-length tape) -> node count.  One-arg: the tape to measure. */
ONE_ARG_BUILTIN(adTapeLength, "eshkol_ad_tape_length_sret")
...
THREE_ARG_BUILTIN(stringTruncateDisplay, "eshkol_builtin_string_truncate_display")
...
TWO_ARG_BUILTIN(constantTimeEqual, "eshkol_builtin_constant_time_equal")
ONE_ARG_BUILTIN(sha256File, "eshkol_builtin_sha256_file")
ONE_ARG_BUILTIN(regexCompile, "eshkol_builtin_regex_compile")
ONE_ARG_BUILTIN(regexFree, "eshkol_builtin_regex_free")
TWO_ARG_BUILTIN(regexMatch, "eshkol_builtin_regex_match")
...
ONE_ARG_BUILTIN(lineReaderClose, "eshkol_builtin_line_reader_close")
ONE_ARG_BUILTIN(fdClose, "eshkol_builtin_fd_close")
ONE_ARG_BUILTIN(makeLruCache, "eshkol_builtin_make_lru_cache")
TWO_ARG_BUILTIN(lruGet, "eshkol_builtin_lru_get")
THREE_ARG_BUILTIN(lruSet, "eshkol_builtin_lru_set")
TWO_ARG_BUILTIN(lruHas, "eshkol_builtin_lru_has")
TWO_ARG_BUILTIN(lruDelete, "eshkol_builtin_lru_delete")
ONE_ARG_BUILTIN(lruClear, "eshkol_builtin_lru_clear")
ONE_ARG_BUILTIN(lruSize, "eshkol_builtin_lru_size")
TWO_ARG_BUILTIN(formatList, "eshkol_builtin_format_list")
...
THREE_ARG_BUILTIN(stringPadRight, "eshkol_builtin_string_pad_right")
