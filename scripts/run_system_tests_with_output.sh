...
eshkol_test_isolation_init "system-out"
...
echo "========================================="
echo "  System Test Suite - Verbose Mode"
echo "========================================="
echo ""
...
# Run all tests in system directory
if [ -d "$TEST_DIR" ]; then
    ...
    echo -e "${RED}System test directory not found: $TEST_DIR${NC}"
    exit 1
fi

# Create summary
echo "=========================================" | tee -a "$RESULTS_FILE"
echo "  System Test Results Summary" | tee -a "$RESULTS_FILE"
echo "=========================================" | tee -a "$RESULTS_FILE"
TOTAL=$((PASS + FAIL))
