...
eshkol_test_isolation_init "features-out"
...
echo "========================================="
echo "  Features Test Suite - Verbose Mode"
echo "========================================="
echo ""
...
# Run all tests in features directory
if [ -d "$TEST_DIR" ]; then
    ...
    echo -e "${RED}Features test directory not found: $TEST_DIR${NC}"
    exit 1
fi

# Create summary
echo "=========================================" | tee -a "$RESULTS_FILE"
echo "  Features Test Results Summary" | tee -a "$RESULTS_FILE"
echo "=========================================" | tee -a "$RESULTS_FILE"
TOTAL=$((PASS + FAIL))
