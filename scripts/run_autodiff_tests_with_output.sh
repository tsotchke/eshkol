...
eshkol_test_isolation_init "autodiff-out"
...
echo "========================================="
echo "  Autodiff Test Suite - Verbose Mode"
echo "========================================="
echo ""
...
if [ -d "$AUTODIFF_DIR" ]; then
    echo "Running tests in $AUTODIFF_DIR..."
    echo ""
...
if [ -d "$AUTODIFF_DEBUG_DIR" ]; then
    echo "Running tests in $AUTODIFF_DEBUG_DIR..."
    echo ""
...
echo "  Autodiff Test Results Summary" | tee -a "$RESULTS_FILE"
echo "=========================================" | tee -a "$RESULTS_FILE"
TOTAL=$((PASS + FAIL))
