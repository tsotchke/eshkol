...
eshkol_test_isolation_init "stdlib-out"
...
echo "========================================="
echo "  Stdlib Test Suite - Verbose Mode"
echo "========================================="
echo ""
...
# Run all tests in stdlib directory
if [ -d "$TEST_DIR" ]; then
    ...
    echo -e "${RED}Stdlib test directory not found: $TEST_DIR${NC}"
    exit 1
fi

# Create summary
echo "=========================================" | tee -a "$RESULTS_FILE"
echo "  Stdlib Test Results Summary" | tee -a "$RESULTS_FILE"
echo "=========================================" | tee -a "$RESULTS_FILE"
TOTAL=$((PASS + FAIL))
