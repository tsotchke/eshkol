...
/* One conservative policy table for assignment conversion across backend
 * ASTs. A form marked as observing can retain or invoke a location after the
 * current frame has been copied. */
