...
int main(int argc, char **argv) {
    ...
    printf("\nNote: the exact i128 path is not a throughput trade-off — measured\n"
           "above, it is FASTER than the f64 baseline, in addition to being\n"
           "BIT-EXACT, order-independent — the reference/certification property\n"
