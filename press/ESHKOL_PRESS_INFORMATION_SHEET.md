...
- **A documentation-truth ratchet.** `scripts/check_surface_counts.py` reads
  ...
  and 1,043 builtins.
  <!-- source: tests/coverage/coverage_policy.json (baseline_surface_total 1108); tests/coverage/language_surface.json (counts.builtins_total 1043); scripts/check_surface_counts.py -->
