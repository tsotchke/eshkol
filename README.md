...
- **Testing**: the v1.3.5-evolve release evidence is the aggregate suite at 46/46 suites, <!-- release-record:ctest -->the full CTest suite<!-- /release-record -->, executable language coverage 1,116/1,116 constructs and <!-- release-record:vm-parity -->VM parity differential **340/340**<!-- /release-record --> over a 961-row manifest (604 `vm-supported`, 46 `native-only-justified`, 311 `gap`), regenerated by the Release workflow at the tagged commit. [docs/TEST_COVERAGE.md](docs/TEST_COVERAGE.md) carries the full record.
