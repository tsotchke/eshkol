.PHONY: help eshkol-swarm-status eshkol-swarm-cycle eshkol-swarm-supervisor-once eshkol-icc-audit eshkol-icc-smoke
...
help:
	...
	@printf '  %-30s %s\n' 'eshkol-swarm-supervisor-once' 'Run one bounded Tsotchke-chan supervisor pass'
...
eshkol-swarm-supervisor-once:
	python3 scripts/eshkol_swarm_daemon.py --once --with-preflight --with-tsotchke-chan
