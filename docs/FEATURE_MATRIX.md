...
the coverage manifest itself: `tests/coverage/language_surface.json` (1,050
...
`surface_total` = **1,113**, confirmed by a fresh run of
...
| **Documentation** |
| API Reference | Yes | Complete | 1,050 builtins across a 1,113-construct declared surface (canonical count, see below) |
...
- Core language (116 special forms, 1,050 builtins — 1,113-construct canonical surface, see "Language surface count" below)
