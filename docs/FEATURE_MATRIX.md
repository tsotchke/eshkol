...
the coverage manifest itself: `tests/coverage/language_surface.json` (1,046
...
`surface_total` = **1,112**, confirmed by a fresh run of
...
| **Documentation** |
| API Reference | Yes | Complete | 1,046 builtins across a 1,112-construct declared surface (canonical count, see below) |
...
- Core language (116 special forms, 1,046 builtins — 1,112-construct canonical surface, see "Language surface count" below)
