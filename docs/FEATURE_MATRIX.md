...
| **Documentation** |
| API Reference | Yes | Complete | 1,046 builtins across a 1,110-construct declared surface (canonical count, see below) |
...
- Core language (116 special forms, 1,046 builtins — 1,110-construct canonical surface, see "Language surface count" below)
