...
the coverage manifest itself: `tests/coverage/language_surface.json` (1,045
...
| **Documentation** |
| API Reference | Yes | Complete | 1,045 builtins across a 1,108-construct declared surface (canonical count, see below) |
...
- Core language (116 special forms, 1,045 builtins — 1,108-construct canonical surface, see "Language surface count" below)
