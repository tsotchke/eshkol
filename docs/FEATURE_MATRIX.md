...
| **Documentation** |
| API Reference | Yes | Complete | 1,044 builtins across a 1,109-construct declared surface (canonical count, see below) |
...
- Core language (116 special forms, 1,044 builtins — 1,109-construct canonical surface, see "Language surface count" below)
