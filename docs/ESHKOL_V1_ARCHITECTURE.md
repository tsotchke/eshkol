...
| Main codegen | 44,314 lines ([`lib/backend/llvm_codegen.cpp`](../lib/backend/llvm_codegen.cpp)) |
...
**Implementation**: [`lib/core/runtime_arena_core.cpp`](../lib/core/runtime_arena_core.cpp) and its `runtime_arena_*` / `runtime_regions` / `runtime_*_alloc` siblings (16,941 lines total), against the [`lib/core/arena_memory.h`](../lib/core/arena_memory.h) interface (1,037 lines)
...
│   │   ├── llvm_codegen.cpp      # Main engine (44,314 lines)
...
**Implementation**: [`CMakeLists.txt`](../CMakeLists.txt) (7,443 lines)
...
- [`lib/backend/llvm_codegen.cpp`](../lib/backend/llvm_codegen.cpp) - Core codegen (44,314 lines)
