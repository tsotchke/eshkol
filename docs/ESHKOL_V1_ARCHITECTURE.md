...
| Main codegen | 44,043 lines ([`lib/backend/llvm_codegen.cpp`](../lib/backend/llvm_codegen.cpp)) |
...
│   │   ├── llvm_codegen.cpp      # Main engine (44,043 lines)
...
│
├── exe/
│   ├── eshkol-run.cpp      # Compiler executable (5,929 lines)
...
- [`lib/backend/llvm_codegen.cpp`](../lib/backend/llvm_codegen.cpp) - Core codegen (44,043 lines)
