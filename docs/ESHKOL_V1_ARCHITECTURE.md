...
**Implementation**: [`lib/core/runtime_arena_core.cpp`](../lib/core/runtime_arena_core.cpp) and its `runtime_arena_*` / `runtime_regions` / `runtime_*_alloc` siblings (4,259 lines total), against the [`lib/core/arena_memory.h`](../lib/core/arena_memory.h) interface (953 lines)
...
**Implementation**: [`exe/eshkol-run.cpp`](../exe/eshkol-run.cpp) (5,892 lines)
...
- [`exe/eshkol-run.cpp`](../exe/eshkol-run.cpp) - Compiler executable (5,892 lines)
