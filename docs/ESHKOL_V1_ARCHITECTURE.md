...
| Main codegen | 44,318 lines ([`lib/backend/llvm_codegen.cpp`](../lib/backend/llvm_codegen.cpp)) |
...
**Implementation**: [`lib/core/runtime_arena_core.cpp`](../lib/core/runtime_arena_core.cpp) and its `runtime_arena_*` / `runtime_regions` / `runtime_*_alloc` siblings (16,941 lines total), against the [`lib/core/arena_memory.h`](../lib/core/arena_memory.h) interface (1,027 lines)
...
**Implementation**: [`inc/eshkol/eshkol.h`](../inc/eshkol/eshkol.h) (3,210 lines)
...
**Implementation**: [`exe/eshkol-run.cpp`](../exe/eshkol-run.cpp) (6,082 lines)
...
```
eshkol/
├── CMakeLists.txt          # Build system (7,403 lines)
...
│   │   ├── llvm_codegen.cpp      # Main engine (44,318 lines)
...
│   │
│   ├── repl/
│   │   ├── repl_jit.cpp     # JIT compiler (4,546 lines)
...
│
├── exe/
│   ├── eshkol-run.cpp      # Compiler executable (6,082 lines)
...
**Implementation**: [`CMakeLists.txt`](../CMakeLists.txt) (7,403 lines)
...
- [`inc/eshkol/eshkol.h`](../inc/eshkol/eshkol.h) - Main system header (3,210 lines)
- [`lib/backend/llvm_codegen.cpp`](../lib/backend/llvm_codegen.cpp) - Core codegen (44,318 lines)
- [`lib/core/runtime_arena_core.cpp`](../lib/core/runtime_arena_core.cpp) - Arena runtime core (720 lines; 4,259 across all `runtime_*` memory modules)
...
- [`exe/eshkol-run.cpp`](../exe/eshkol-run.cpp) - Compiler executable (6,082 lines)
