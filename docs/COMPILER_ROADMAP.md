...
## Current status (v1.3.5-evolve)

**Release source**: the `v1.3.5-evolve` tag.
**Last shipped release**: v1.3.5-evolve (2026-09-22); before it, v1.3.4-evolve
on 2026-08-19 at commit `694c3179`.
**Status**: released. The callee-identity, type-precision and ICC-invariant
hardening is integrated. The canonical surface inventory contains 1,052 builtins
and 1,115 constructs; execution coverage, CTest, VM parity, engine parity,
package checks and ICC readiness are regenerated by the Release workflow at the
tagged commit. See [FEATURE_MATRIX.md](FEATURE_MATRIX.md) and the "Final
verification" section of [RELEASE_NOTES.md](../RELEASE_NOTES.md).
