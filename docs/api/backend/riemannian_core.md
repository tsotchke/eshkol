...
36 public symbol(s) — 26 documented, 10 undocumented.
...
| Symbol | Kind | Line |
|---|---|---:|
| `ESHKOL_RM_LAMBDA0` | Macro | 98 |
| `ESHKOL_RM_FLAT_LAMBDA` | Macro | 104 |
| `ESHKOL_RM_ZERO_NORM` | Macro | 108 |
| `ESHKOL_RM_SPHERE_TOL` | Macro | 114 |
| `ESHKOL_RM_TANGENT_TOL` | Macro | 122 |
| `ESHKOL_RM_PSI_SMALL` | Macro | 127 |
| `ESHKOL_RM_TAU_SMALL` | Macro | 130 |
| `ESHKOL_RM_GRAM_EXACT_DIM` | Macro | 136 |
