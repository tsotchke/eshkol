...
54 public symbol(s) — 23 documented, 31 undocumented.
...
Map with a runtime closure over N lists in lockstep. R7RS stops at the shortest list and passes one element from every list to the closure on each iteration.
