...
75 public symbol(s) — 57 documented, 18 undocumented.
...
The FILE* of a port argument of `direction` (ESHKOL_PORT_INPUT_FLAG or ESHKOL_PORT_OUTPUT_FLAG); any other value raises a catchable type error naming `proc_name.` Every optional-port argument of an I/O builtin goes through here.
...
| `StringIOCodegen::openOutputFileImpl` | Function | 313 |
| `StringIOCodegen::closePort` | Function | 321 |
| `StringIOCodegen::ctx_` | Variable | 445 |
| `StringIOCodegen::tagged_` | Variable | 447 |
| `StringIOCodegen::nullptr` | Variable | 448 |
| `StringIOCodegen::nullptr` | Variable | 449 |
| `StringIOCodegen::CodegenASTFunc` | Typedef | 470 |
| `StringIOCodegen::CodegenTypedASTFunc` | Typedef | 471 |
| `StringIOCodegen::TypedToTaggedFunc` | Typedef | 472 |
| `StringIOCodegen::ConsCreateFunc` | Typedef | 473 |
| `StringIOCodegen::nullptr` | Variable | 475 |
| `StringIOCodegen::nullptr` | Variable | 476 |
| `StringIOCodegen::nullptr` | Variable | 477 |
| `StringIOCodegen::nullptr` | Variable | 478 |
| `StringIOCodegen::nullptr` | Variable | 479 |
| `StringIOCodegen::setCodegenCallbacks` | Function | 481 |
| `StringIOCodegen::nullptr` | Variable | 530 |
