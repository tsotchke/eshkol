...
| [0030](0030-program-entry-and-physical-names.md) | One program-entry rule and Eshkol-owned physical names (implements ADR-0006 section 5) | Accepted — design; implementation planned for v1.4 | 2026-09-25 | v1.4.0 |
