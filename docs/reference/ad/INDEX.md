...
| [support-matrix.md](support-matrix.md) | The AD-oracle support matrix (235 probes / 490 checks), the PASS cells, [nesting](support-matrix.md#nesting), the five cells that were open through v1.3.3 and are now closed (ESH-0072/0078/0095/0096/0097), and how to run `scripts/run_ad_oracle.sh`. |
