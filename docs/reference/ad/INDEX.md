...
| [tape.md](tape.md) | The explicit reverse-mode tape builtins (`ad-tape-new`, `ad-var`, `ad-mul`, `ad-backward`, `ad-gradient`, `ad-pow`, `ad-tape-length`, `ad-tape-release`, …) and the AD instrumentation counters (`ad-counters`, `ad-finite-difference-evals`, `ad-note-finite-difference!`) — 33 names, both engines. |
