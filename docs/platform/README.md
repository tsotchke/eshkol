...
- `atomic-load`, `atomic-store!`, `atomic-exchange!`, `atomic-fetch-add!`, and `atomic-fetch-sub!` exist for typed raw-pointer atomic access with explicit memory orderings
