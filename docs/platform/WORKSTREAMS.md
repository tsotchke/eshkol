...
- `--require-vm-entry-zero-arg` lowers to zero-parameter/no-upvalue metadata
  admission and is exercised by the profile CLI test for accepted
  zero-argument hooks and rejected parameterized hooks
