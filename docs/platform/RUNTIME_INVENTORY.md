...
4. Continue splitting `arena_memory.cpp` along host-dependent seams. The
   ...
   freestanding-safe tensor index, tensor fill, string, bytevector, and closure
   reflection/lambda-registry helpers are dedicated runtime-core units, and the
