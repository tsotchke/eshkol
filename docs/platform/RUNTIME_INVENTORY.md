...
4. Continue splitting `arena_memory.cpp` along host-dependent seams. The
   ...
   reflection/lambda-registry, continuation/dynamic-wind, hash-table, and
   automatic-differentiation helpers are dedicated runtime-core units, and the
