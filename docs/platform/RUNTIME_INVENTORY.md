...
4. Continue splitting `arena_memory.cpp` along host-dependent seams. The
   ...
   reflection/lambda-registry, and continuation/dynamic-wind helpers are
   dedicated runtime-core units, and the
