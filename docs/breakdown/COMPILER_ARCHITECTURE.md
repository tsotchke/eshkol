...
+------------------+
       ...
       v
+------------------+
| 4. LLVM IR       |  lib/backend/llvm_codegen.cpp (44,314 lines)
...
**Implementation:** [`lib/backend/llvm_codegen.cpp`](../../lib/backend/llvm_codegen.cpp) (44,314 lines)
...
|:---|:---|---:|:---|
| **Main Codegen** | [`llvm_codegen.cpp`](../../lib/backend/llvm_codegen.cpp) | 44,314 | Orchestrator, AST dispatch, builtins, consciousness engine |
