...
**Phase 4: LLVM IR Generation** (44,314 lines in [llvm_codegen.cpp](../../lib/backend/llvm_codegen.cpp) plus 35 further specialised modules; the compiler tree as a whole totals about 329,100 lines)

Translates ASTs to LLVM IR. The modular architecture distributes code generation across specialized modules:

| Module | Lines | Responsibility |
|:---|---:|:---|
| [llvm_codegen.cpp](../../lib/backend/llvm_codegen.cpp) | 44,314 | Main codegen, dispatch, builtins |
