...
Limitation: go-to-definition is document-local only. Cross-file navigation (e.g. jumping to a `provide`d symbol in another module) is not supported in v1.1.11.
