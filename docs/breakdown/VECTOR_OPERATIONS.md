...
**Implementation**: [`lib/backend/tensor_codegen.cpp`](../../lib/backend/tensor_codegen.cpp) (thin dispatcher over twelve `tensor_*_codegen.cpp` siblings after the v1.2 split)
