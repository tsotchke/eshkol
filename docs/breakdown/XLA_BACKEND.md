...
**Source**: `lib/backend/xla/xla_runtime.cpp` (1,376 lines), `inc/eshkol/backend/xla/xla_codegen.h`, `inc/eshkol/backend/xla/xla_runtime.h`
...
- `lib/backend/xla/xla_runtime.cpp` — all 11 C runtime functions (1,376 lines)
