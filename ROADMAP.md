...
## v1.3.5-evolve — the consolidation release (refreshed 2026-09-14) - RELEASE CANDIDATE

Planned release date: Monday, September 14, 2026, after 09:00 America/Montreal.
The candidate is being refreshed from `origin/master` (`0c0436d5`).
Callee-identity, type-precision and ICC-invariant hardening remain open, and
the final verification battery has not been run on this refreshed source.
The September 11 results recorded for the earlier candidate are historical;
they do not establish readiness for this refresh. Do not publish or claim a
readiness score until the hardening work and exact-head release checks are
complete. See [RELEASE_NOTES.md](RELEASE_NOTES.md).
...
- AD: SW-05 forward-over-reverse; ESH-0101 (native stack guard coverage for
  ...
  `scripts/run_stack_overflow_diagnostic.sh` — see KNOWN_ISSUES.md); **The P6/P11 re-verification is DONE**
...
*Last Updated: 2026-09-14 (v1.3.5-evolve refreshed release candidate — the v1.3.5 section
...
*Eshkol v1.1-accelerate is complete with 47/47 roadmap items delivered plus the v1.1.12 and v1.1.13 additions (production VM, web platform, browser AD, Windows ARM64, mobile site). The v1.3 line runs through v1.3.5-evolve, whose refreshed candidate is dated 2026-09-14 and awaits hardening and exact-head verification before any release claim. The roadmap progresses through data & deployment (v1.2-scale), language maturity (v1.3-evolve), consolidation (v1.3.5), networking & resources (v1.4.0-connection), the ABI release (v1.4.1), neuro-symbolic intelligence (v1.5.0-intelligence), symbolic reasoning (v1.6.0-reasoning), program synthesis (v1.7.0-synthesis), platform & hardware (v1.8.0-platform), advanced type theory (v1.9.0-types), and quantum computing with formal verification (v2.0-starlight) — with a two-tier distributed-computing workstream (W6) running underneath the whole v1.4.0→v2.0 span rather than confined to one release.*
