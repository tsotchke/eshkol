...
| BUG D — cascading "Undefined variable" in nested defines | TODO  | LLVM verifier "Terminator found in middle of basic block" surfaces in Sigma mini-bench. Plausibly subsumed by BUG C in some cases; remaining cases need minimal repro before fix. |
